export const garageLevels = [
    ...
    },
    {
        ...
        cars: [
            { src: '../assets/images/car-photos/automobili-pininfarina-battista.jpg', alt:'Automobili Pininfarina Battista', caption: 'Automobili Pininfarina Battista' }
        ]
    },
    {
        level: 40,
    ...
    {
        level: 41,
        xpRequired: '5,250,000',
        cars: [
            { src: '../assets/images/car-photos/italdesign-davinci.jpg', alt:'Italdesign DaVinci', caption: 'Italdesign DaVinci' },
            { src: '../assets/images/car-photos/renault-trezor.jpg', alt:'Renault Trezor', caption: 'Renault Trezor' }
        ]
    },
    {
        level: 42,
